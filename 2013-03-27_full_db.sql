...
ALTER TABLE `matchResults`
  ...
  ADD CONSTRAINT `matchResults_ibfk_4` FOREIGN KEY (`assist`) REFERENCES `players` (`playerId`),
...
INSERT INTO `staff` (`staffId`, `username`, `firstname`, `surname`, `password`, `email`, `manager`) VALUES
(1, 'admin', 'Your', 'Name', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'email@domain.com', 1);